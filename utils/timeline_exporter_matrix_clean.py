...
def generate_html(events=None, output_path=None, title_suffix=""):
    ...
    try:
        ...
        html.append('           "<td class=\\\"col-oldvalue\\\">"+JSON.stringify(((()=>{let v=(d.old_value===undefined?"":d.old_value);let n=parseFloat(v);if(!isNaN(n)){v=roundTo(n).toString();}return v;})()))+"</td>"+')
        html.append('           "<td class=\\\"col-newvalue\\\">"+JSON.stringify(((()=>{let v=(d.new_value===undefined?"":d.new_value);let n=parseFloat(v);if(!isNaN(n)){v=roundTo(n).toString();}return v;})()))+"</td>"+')
        ...
        html.append('    // 監聽變更事件')
        html.append('    decInput.addEventListener("change", ()=>{')
        ...
        html.append('    apply.addEventListener("click", ()=>{')
